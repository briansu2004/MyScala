...
- [ZIO + Spark = Zparkio](#zio--spark--zparkio)
- [Scala 2 cheat sheet](#scala-2-cheat-sheet)
- [Variance : Covariance vs Contravariance vs Invariance](#variance--covariance-vs-contravariance-vs-invariance)
- [Scala Worksheet and Compiling Server issue and solution](#scala-worksheet-and-compiling-server-issue-and-solution)
- [2022-02-12 re-create sbt project](#2022-02-12-re-create-sbt-project)
  - [Scala: Any, AnyVal, AnyRef](#scala-any-anyval-anyref)
  - [Scala: Case class](#scala-case-class)
  - [Scala: Type class](#scala-type-class)
  - [Scala: mkString](#scala-mkstring)
  - [Scala: WorkSheet](#scala-worksheet)
  - [Scala: Monad](#scala-monad)
  - [Scala: for-comprehension](#scala-for-comprehension)
  - [Scala: ZIO Stream](#scala-zio-stream)
  - [Scala: Variance](#scala-variance)
  - [Scala: CATS](#scala-cats)
  - [Scala: Pure](#scala-pure)
- [Scala: CATS](#scala-cats-1)
- [2022-02-19](#2022-02-19)
  - [reduceOption](#reduceoption)
  - [Scalaz](#scalaz)
  - [Cats Effect](#cats-effect)
- [Scala with Cats Book](#scala-with-cats-book)
  - [sbt (aka scala build tool)](#sbt-aka-scala-build-tool)
  - [Lightbend (\<- Typesafe)](#lightbend---typesafe)
  - [Flash scope vs Session scope](#flash-scope-vs-session-scope)
  - [Scala Web MVC \& REST : Play framework (built on Akka)](#scala-web-mvc--rest--play-framework-built-on-akka)
  - [Scala \& Akka HTTP](#scala--akka-http)
  - [Akka HTTP \& JSON: Integrating Spray, Circe and Jackson with Akka HTTP, with Scala](#akka-http--json-integrating-spray-circe-and-jackson-with-akka-http-with-scala)
- [2022-02-20](#2022-02-20)
  - [GitBook](#gitbook)
  - [Scala.js](#scalajs)
- [2022-02-21](#2022-02-21)
  - [Book: Scala With Cats](#book-scala-with-cats)
  - [Good explanations on Type Class (and Type Class instances, implicit) in Scala interview](#good-explanations-on-type-class-and-type-class-instances-implicit-in-scala-interview)
  - [sbt task failed, see log for details](#sbt-task-failed-see-log-for-details)
- [2022-02-23](#2022-02-23)
  - [ZIO](#zio)
  - [ZIO effect](#zio-effect)
  - [Monix](#monix)
  - [http4s](#http4s)
  - [ZIO get started](#zio-get-started)
- [2022-02-26](#2022-02-26)
- [2022-02-27](#2022-02-27)
- [2022-05-16](#2022-05-16)
- [2022-05-17](#2022-05-17)
  - [Trick - PrintWriter](#trick---printwriter)
  - [Trick - "Redirect input from"](#trick---redirect-input-from)
