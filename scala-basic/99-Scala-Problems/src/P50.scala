...
//      // This ordering chooses q1 in case of ties, which helps minimize tree depth.
...
//    }
//
//    huffmanR(Queue.Empty.enqueue(ls sort { _._2 < _._2 } map { e => LeafNode(e._1, e._2) }), Queue.Empty)
//  }
  ...
  def main(args: Array[String]): Unit = {
    var l = List(("a", 45), ("b", 13), ("c", 12), ("d", 16), ("e", 9), ("f", 5))
    var start = LocalDateTime.now()
    println(s"The Huffman code of $l is: ${huffman(l)}")
