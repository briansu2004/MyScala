object PartitionByValue {
  def main(args: Array[String]): Unit = {
    ...
    println(partitionByValue(mp, 1))
    println(partitionByValue(mp, 3))
    println(partitionByValue(mp, 0))
  }

  def partitionByValue[A](m: Map[A, List[Int]], n: Int): List[Map[A, List[Int]]] = {
